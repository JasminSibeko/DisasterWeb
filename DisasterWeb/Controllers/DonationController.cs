...
using DisasterWeb.Models;
using DisasterWeb.Data;

namespace DisasterWeb.Controllers
{
    public class DonationController : Controller
    {
        ...
        public async Task<IActionResult> Donate(ResourceDonation donation)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["SuccessMessage"] = "Thank you for your donation! We will get in touch with you in a minute, to arrange collection.";
